...
export default function ForecastResultPage() {
  ...
  // ── Build chart once forecast loaded ─────────────────────────────────────
  useEffect(() => {
      ...
      chartInstance.current = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            ...
            },
            {
              ...
              data: p90,
              borderColor: 'rgba(91,158,110,0.75)',
              borderWidth: 1.5,
              borderDash: [5, 4],
              pointRadius: 0,
              fill: false,
            ...
            },
            {
              ...
              borderColor: '#c9a84c',
              borderWidth: 2.5,
              pointRadius: ages.map((a) => (a === pensionAge ? 5 : 0)),
            ...
            },
            {
              ...
              data: p10,
              borderColor: 'rgba(192,97,74,0.75)',
              borderWidth: 1.5,
              borderDash: [5, 4],
              pointRadius: 0,
              fill: false,
        ...
        options: {
          ...
          plugins: {
            ...
            tooltip: {
              backgroundColor: 'rgba(13,31,53,0.97)',
          ...
          scales: {
            x: {
              ticks: {
                ...
                maxTicksLimit: 10,
                callback: (val, i) => (ages[i] % 5 === 0 ? 'Age ' + ages[i] : ''),
              },
      ...
      <div className="hf-root">
        ...
        <nav className="hf-nav">
          ...
          <div className="hf-nav-right">
            ...
            <button className="hf-btn-outline" onClick={() => router.push('/dashboard')}>
              Dashboard
            </button>
          </div>
        </nav>
        ...
        <div className="hf-page">
          ...
          <div className="hf-header">
            ...
            <button className="hf-recalc-btn" onClick={() => router.push('/forecast/new')}>
              ✎ Adjust inputs
            </button>
          </div>
          ...
          <div className="hf-stat-grid">
            <div className="hf-stat-card hf-stat-gold">
              ...
              <div className="hf-stat-value gold">
                {retirementBalanceMedian ? fmt(retirementBalanceMedian) : '—'}
              </div>
              <div className="hf-stat-sub">
                Median estimate at age {retirementAge}<br />
          ...
          <div className="hf-chart-section">
            <div className="hf-chart-top">
              ...
              <div className="hf-chart-legend">
                <div className="hf-legend-item">
                  <div className="hf-legend-line" style={{ borderTop: '2px dashed #7ec896' }} />
                  <span style={{ color: '#7ec896' }}>Best case (90th %ile)</span>
                </div>
                <div className="hf-legend-item">
                  <div className="hf-legend-line" style={{ background: '#c9a84c', height: 2 }} />
                  <span style={{ color: '#c9a84c' }}>Median (50th %ile)</span>
                </div>
                <div className="hf-legend-item">
                  <div className="hf-legend-line" style={{ borderTop: '2px dashed #e08878' }} />
                  <span style={{ color: '#e08878' }}>Worst case (10th %ile)</span>
                </div>
                <div className="hf-legend-item">
                  <div className="hf-legend-line" style={{ borderTop: '1px dashed rgba(255,255,255,0.35)' }} />
                  <span style={{ color: 'rgba(255,255,255,0.4)' }}>Spending target</span>
                </div>
              </div>
            </div>
            ...
            <div className="hf-chart-note">
              Based on 1,000 simulated scenarios · Assumes single homeowner · 2.5% inflation · Returns modelled net of fees
            </div>
          </div>
          ...
          <div className="hf-summary-section">
            ...
            <div className="hf-summary-rows">
              <div className="hf-summary-row">
                <div className="hf-summary-row-label">Best case · funds last</div>
                <div className="hf-summary-row-val green">{fmtAge(fundsLastP90)}</div>
              </div>
              <div className="hf-summary-row">
                <div className="hf-summary-row-label">Median · funds last</div>
                <div className="hf-summary-row-val gold">{fmtAge(fundsLastP50)}</div>
              </div>
              <div className="hf-summary-row">
                <div className="hf-summary-row-label">Worst case · funds last</div>
                <div className="hf-summary-row-val red">{fmtAge(fundsLastP10)}</div>
              </div>
            </div>
          </div>
